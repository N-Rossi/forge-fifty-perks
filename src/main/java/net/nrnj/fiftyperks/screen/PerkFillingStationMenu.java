...
public class PerkFillingStationMenu extends AbstractContainerMenu {

    public final PerkFillingStationBlockEntity blockEntity;
    ...
    public boolean stillValid(Player pPlayer) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
                pPlayer, ModBlocks.PERK_FILLING_STATION.get());
    }
