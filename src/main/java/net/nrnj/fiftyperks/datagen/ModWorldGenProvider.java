...
import net.nrnj.fiftyperks.worldgen.ModBiomeModifiers;
import net.nrnj.fiftyperks.worldgen.ModConfiguredFeatures;
import net.nrnj.fiftyperks.worldgen.ModPlacedFeatures;
